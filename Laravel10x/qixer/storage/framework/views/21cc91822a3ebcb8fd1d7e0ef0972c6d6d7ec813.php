                                ...
                                <div class="card-body">
                                    <div class="gig-chat-message-heading">
                                        <div class="header-wrap d-flex justify-content-between">
                                            ...
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(route('seller.support.ticket')); ?>"><?php echo e(__('All Tickets')); ?></a>
                                        </div>
                                        ...
                                        <div class="gig-order-info">
                                            ...
                                            <p><strong><?php echo e(__('Status:')); ?></strong> <span class="status-<?php echo e($ticket_details->status); ?>"><?php echo e(__(ucfirst($ticket_details->status))); ?></span></p>
                                            <p><strong><?php echo e(__('Priority:')); ?></strong> <span class="<?php echo e($ticket_details->priority); ?>"><?php echo e(__(ucfirst($ticket_details->priority))); ?></span></p>
...
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/seller/support-ticket/view-ticket.blade.php ENDPATH**/ ?>