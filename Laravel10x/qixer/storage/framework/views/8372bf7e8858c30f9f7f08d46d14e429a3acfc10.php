...
<?php endif; ?>
                    ...
                    <div class="btn-wrapper margin-top-50 text-right">
                        <a href="#" class="cmn-btn btn-bg-1" data-toggle="modal"
                           data-target="#ticketModal" > <?php echo e(__('Create Ticket For A Order' )); ?>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($data->priority=='low'): ?><span class="btn btn-primary btn-sm btn-bg-1"><?php echo e(__(ucfirst($data->priority))); ?></span><?php endif; ?>
                                            <?php if($data->priority=='high'): ?><span class="btn btn-warning btn-sm btn-bg-1"><?php echo e(__(ucfirst($data->priority))); ?></span><?php endif; ?>
                                            <?php if($data->priority=='medium'): ?><span class="btn btn-info btn-sm btn-bg-1"><?php echo e(__(ucfirst($data->priority))); ?></span><?php endif; ?>
                                            <?php if($data->priority=='urgent'): ?><span class="btn btn-danger btn-sm btn-bg-1"><?php echo e(__(ucfirst($data->priority))); ?></span><?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($data->status=='open'): ?>
                                            <span class="btn btn-primary btn-sm btn-bg-1"><?php echo e(__(ucfirst($data->status))); ?></span>



                                            <?php else: ?>
                                            <span class="btn btn-danger btn-sm btn-bg-1"><?php echo e(__(ucfirst($data->status))); ?></span>
                                        ...
                                        <td>
                                            <div class="dashboard-switch-single">
                                               <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.seller-delete-popup','data' => ['url' => route('seller.support.ticket.delete',$data->id)]]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/seller/support-ticket/all-tickets.blade.php ENDPATH**/ ?>