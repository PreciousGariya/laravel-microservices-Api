...
<?php endif; ?>
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.add.service.attributes.by.id',$get_service->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/backend/pages/services/admin-service/add_service_attributes_by_id.blade.php ENDPATH**/ ?>