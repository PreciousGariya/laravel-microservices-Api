...
function render_page_meta_data_for_category($category){
    ...
    $facebook_meta_tags = $category->metaData->facebook_meta_tags ?? '';
    ...
    $twitter_meta_tags = $category->metaData->twitter_meta_tags ?? '';
...
function render_page_meta_data_for_subcategory($subcategory){
    ...
    $facebook_meta_tags = $subcategory->metaData->facebook_meta_tags ?? '';
    ...
    $twitter_meta_tags = $subcategory->metaData->twitter_meta_tags ?? '';
...
function render_page_meta_data_for_child_category($child_category){
    ...
    $facebook_meta_tags = $child_category->metaData->facebook_meta_tags ?? '';
    ...
    $twitter_meta_tags = $child_category->metaData->twitter_meta_tags ?? '';
